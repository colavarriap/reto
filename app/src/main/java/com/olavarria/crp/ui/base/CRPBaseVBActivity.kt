...
import com.olavarria.core.base.activity.BaseVmVbActivity
import com.olavarria.crp.extensions.collect
import com.olavarria.crp.ui.dialog.LoadingDialog

abstract class CRPBaseVBActivity<VM : CRPBaseViewModel, VB : ViewBinding> : BaseVmVbActivity<VM, VB>(), BaseView {
